window.TEST_IDENTIFIER = 'reading_grade5_2015';
...
fish! This human-looking fish is the blobfish. The blobfish may not
be the most attractive of sea creatures, but it is certainly one of the
most interesting. This uncommon fish exists only off the coasts of
...
family and anxious for the other campers to arrive.</p>
   ...
   '4': {
    title: 'Kitchen Kids--A Cookbook for the Young Chef',
    content: `
...
syrups yourself</p>
      ...
      <h2>Delicious Drizzle</h2>
        ...
        <p><b><u>Choose Your Favorite Fruit</u></b></p>
        <p><ul>
        <li>blackberries</li>
        <li>blueberries</li>
        <li>cherries</li>
      ...
      <p><b><u>To Make the Syrup</u></b></p>
      
      <p><ol>
      <li>Place the fruit inside the strainer and rinse under cold water.
Ask an adult to use the knife to remove stems and/or pits and
cores, and then let the fruit air-dry.</li>
      <li>Using the potato masher, mash the fruit in the stovetop pan
until it is smooth and has very few lumps.</li>
      <li>Add the cup of water to the mashed fruit.</li>
      <li>With an adult present, heat and stir the mixture until it
boils. Cook the fruit until it becomes juicy. This should take
about 10 minutes.</li>
      <li>Pour the fruit and the juice through the strainer and into a
bowl to discard any skin or seeds that have separated from
the fruit while cooking.</li>
      <li>Add the sugar to the fruit mixture, stir, and then return the
mixture to the pan.</li>
      <li>Boil the mixture for about one minute. Foam may form
while you boil the sugar and fruit mixture. Do not be
concerned if you see the foam. This is a normal reaction
caused by pectin.* The foam is not harmful to eat, but it
does not have a pleasant taste, so it should be removed.</li>
      <li>Use a spoon to remove any foam that collects on top of
the syrup.</li>
      <li>Allow the syrup to cool before serving.</li>
      </ol></p>

      <p>*Pectin is a kind of sugar present in ripe fruit. Pectin is what
causes jams and jellies to thicken. Some fruits, like
blackberries and apples, contain a large amount of pectin.
Be careful not to overcook these fruits, or your syrup may
become too thick.</p>

<p><b><u>Follow These Helpful Cooking Hints</u></b></p>
<p><ul>
<li>Fresh fruits make the best syrups.</li>
<li>Make sure to have the help of an adult when using
the stove or knife.</li>
<li>Add a half-tablespoon of fresh lemon juice or grated
lemon peel for extra flavor during Step 4.</li>
</ul></p>

<p><b><u>Try Your Syrup On...</u></b></p>
<p><ul>
<li>pancakes or waffles</li>
<li>ice cream or yogurt</li>
<li>biscuits or rolls</li>
<li>oatmeal or granola</li>
</ul></p>

<p>Note: Because this syrup is not pasteurized (a special
heating process that kills germs and prevents food
from spoiling), it is only fresh and safe to eat for one
to two days.</p>
    `
  },
...
companies, Virgin Galactic, plans to provide 50,000 people with
tours of space within its first 10 years. Virgin Galactic already has at
least 300 people registered for a trip to space. Branson has hinted
at possible future plans for a space hotel. He once told a news
...
prepare them for their stay. Once training is completed, they will
board a Russian spacecraft and head to the space resort. Traveling
...
spacecraft and step
inside the space hotel.
Each guest will be
assigned to a living unit.
In their chambers, guests
will be provided with
Velcro™ suits. Wearing the suits, guests will be able to stick to the
walls as they eat or sleep. The Velcro suits will help keep the guests
...
<li>to celebrate her race!</li><br>
</ol>
    `
  },
};
...
const sampleQuestions = [
  {
    id: '1',
    text: 'What does the word <u>devised</u> mean in paragraph 2?',
  ...
  {
    id: '2', 
    text: 'At the beginning of the story, what does Charlie think about the morning news program?',
    type: 'multiple-choice',
    passageId: '1',
    options: [
  ...
  {
    id: '3',
    text: 'Charlie\'s mother calls him an "experimenter" because he--',
    type: 'multiple-choice',
    passageId: '1',
    options: [
      'invents things for school',
      'wants to change the news', 
  ...
  {
    id: '4',
    text: 'What happens as Charlie walks to his classroom?',
    type: 'multiple-choice',
    passageId: '1',
    options: [
      'He asks his teacher what she thinks about his suggestion.',
      'He decides to end the news show with music.',
  ...
  {
    id: '5',
    text: 'Why does Charlie wait until after school to share his idea with Mrs. Barnes?',
    type: 'multiple-choice', 
    passageId: '1',
    options: [
      'He feels he should talk to the music teacher first.',
      'He wants to discuss it that morning, but the bell rings.',
  ...
  {
    id: '6',
    text: 'Based on the ending of the story, what will Charlie most likely do during the next school news program?',
    type: 'multiple-choice', 
    passageId: '1',
    options: [
      'Tell a funny story',
      'Sing with the music teacher',
  ...
  {
    id: '7',
    text: 'Which would be the best heading for paragraph 2?',
    type: 'multiple-choice',
    passageId: '2',
    options: [
      'A New Discovery',
  ...
  {
    id: '8',
    text: 'How is the information in paragraphs 5 and 6 organized?',
    type: 'multiple-choice',
    passageId: '2', 
    options: [
      'Listing',
