...
SOLace has no student logins. Instead, all test data is stored in the cache on the user's device in their browser. However, teachers can choose to create accounts to track their students' progress on the site.
